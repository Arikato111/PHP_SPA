...
```
- ในตัวอย่างนี้จะเป็นการ `require` เข้ามาทำงานร่วมกับ `Route` ซึ่งได้มีการใช้ `require` และสร้างตัวแปรมารับค่า ซึ่งตัวแปรนั้นจะมี `type` เป็น `function`  ดังเช่นในตัวอย่าง
